...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		break;
	case WM_LBUTTONDOWN:
		MessageBox(hwnd, TEXT("Mouse's Left button pressed"), TEXT("Message"), MB_OK);
		break;
	case WM_KEYDOWN:
		MessageBox(hwnd, TEXT("In WM_KEYDOWN"), TEXT("Message"), MB_OK);
		break;
	case WM_CHAR:
		MessageBox(hwnd, TEXT("In WM_CHAR"), TEXT("Message"), MB_OK);
		break;
	case WM_DESTROY:
		PostQuitMessage(0);
		break;
