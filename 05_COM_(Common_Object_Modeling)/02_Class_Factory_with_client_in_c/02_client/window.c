// header files
#include <windows.h>
#include "ClassFactoryWithDefAndRegFile_C.h"
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	switch(iMsg)
	{
		case WM_CREATE:
			...
			iNum2 = 10;
			iAns = 0;
			gpISum->lpVtbl->SumOfTwoIntegers(gpISum, iNum1, iNum2, &iAns);
			...
			gpISubtract->lpVtbl->SubtractionOfTwoIntegers(gpISubtract, iNum1, iNum2, &iAns);
